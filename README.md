...
|站点|地址|内容|
|---|---|---|
|📝 博客 + 教程 | [aigcwei.cn](https://aigcwei.cn/)|Helios's AILab：博客文章流 + 技术笔记库 + 七线技术教程（Kotlin / LVGL / ESP32 电子墨水屏 / SF32 / C++ / 图像与视觉 / C++ 底层原理）|
...
|项目|简介|
|---|---|
|🎓 [Helios 技术教程](https://aigcwei.cn/learn/)|七线系统教程：Kotlin/Android、LVGL 嵌入式图形、ESP32 电子墨水屏阅读器、SF32 电子书移植、C++ 工程实践、图像与视觉实战、C++ 底层原理，各 16 章，含导师讲解、代码高亮与互动练习|
